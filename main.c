...
#define SENSOR_AD   1
#define SENSOR_LM35 2

#define SENSOR      SENSOR_AD
...
#define T_MAX   1480    // 150.0 C   - было 1470
...
ISR(ADC_vect)
{
 ...
 #if SENSOR == SENSOR_AD
    v = (AdcBuf * 500) / 1024;  // напряжение, умноженное на 100
 #else
    v = (AdcBuf * 5030) / 1024;    // Напряжение для LM35
 #endif   
 ...
 #if SENSOR == SENSOR_AD
    // Расчет температуры для датчика AD
